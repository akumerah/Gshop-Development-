...
//ketika bars di klik //
document.querySelector("#bars").onclick = event => {
...
document.querySelector("#shoping").onclick = event => {
...
itemCards.forEach(function (itemCard) {
    ...
    var price = itemCard.querySelector(
...
document.addEventListener("DOMContentLoaded", function () {
 ...
 /* alert icons krenjang dalam perbaikan, masukan class itemShoppingCarts */
document.addEventListener("DOMContentLoaded", function () {
    const itemShoppingCarts = document.querySelectorAll(".item-shopping-cart");
    let clickCount = 0;
